...
BID_MODIFIED_BY_LEADER = 'BID_MODIFIED_BY_LEADER'
...
DISTRIBUTION_GROUP_CREATED = 'DISTRIBUTION_GROUP_CREATED'
DISTRIBUTION_GROUP_DELETED = 'DISTRIBUTION_GROUP_DELETED'
USER_ASSIGNED_TO_DISTRIBUTION_GROUP = 'USER_ASSIGNED_TO_DISTRIBUTION_GROUP'
DISTRIBUTION_GROUP_MARKED_DONE = 'DISTRIBUTION_GROUP_MARKED_DONE'
...
TAG_UNVERIFIED = 'TAG_UNVERIFIED'
TAGS_MERGED = 'TAGS_MERGED'
TAG_ADDED_TO_PRODUCT = 'TAG_ADDED_TO_PRODUCT'
TAG_REMOVED_FROM_PRODUCT = 'TAG_REMOVED_FROM_PRODUCT'
...
SUCCESS_CODE_GROUPS = {
    ...
    'Tags': [
        ...
        TAG_UNVERIFIED,
        TAGS_MERGED,
        TAG_ADDED_TO_PRODUCT,
        TAG_REMOVED_FROM_PRODUCT,
    ],
    'Admin': [
