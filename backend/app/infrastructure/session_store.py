...
class SessionStore(ABC):
    ...
    @abstractmethod
    async def set(self, session_token: str, session_data: dict[str, Any], ttl_seconds: int) -> None:
        """Store session data with TTL."""
        pass

    @abstractmethod
    async def get(self, session_token: str) -> dict[str, Any] | None:
...
class RedisSessionStore(SessionStore):
    ...
    def __init__(self, redis_url: str):
        ...
        logger.info('Redis session store created', extra={'redis_url': redis_url})
    ...
    async def set(self, session_token: str, session_data: dict[str, Any], ttl_seconds: int) -> None:
        ...
        try:
            ...
            await self.redis.hset(key, mapping=serialized_data)
