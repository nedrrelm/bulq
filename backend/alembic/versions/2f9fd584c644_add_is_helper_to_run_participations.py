...
def upgrade() -> None:
    ...
    op.add_column(
        'groups',
        sa.Column('is_joining_allowed', sa.Boolean(), nullable=False, server_default='true'),
    )
    op.add_column(
        'groups',
        sa.Column(
    ...
    op.create_index(
        'ix_reassignment_requests_run_status',
        'leader_reassignment_requests',
        ['run_id', 'status'],
        unique=False,
    )
    op.create_index(
        'ix_reassignment_requests_to_user_status',
        'leader_reassignment_requests',
        ['to_user_id', 'status'],
        unique=False,
    )
    ...
    op.create_index(
        'ix_product_availabilities_product_store',
        'product_availabilities',
        ['product_id', 'store_id'],
        unique=False,
    )
    op.create_index(
        'ix_product_availabilities_store_created',
        'product_availabilities',
        ['store_id', 'created_at'],
        unique=False,
    )
    ...
    op.add_column(
        'product_bids',
        sa.Column('distributed_price_per_unit', sa.DECIMAL(precision=10, scale=2), nullable=True),
    )
    op.add_column(
        'product_bids',
        sa.Column('is_picked_up', sa.Boolean(), nullable=False, server_default='false'),
    )
    op.add_column(
        'product_bids', sa.Column('picked_up_at', sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        'product_bids',
        sa.Column(
    ...
    op.create_index(
        op.f('ix_product_bids_participation_id'), 'product_bids', ['participation_id'], unique=False
    )
    op.create_index(
        'ix_product_bids_participation_product',
        'product_bids',
        ['participation_id', 'product_id'],
        unique=False,
    )
    op.create_index(
        op.f('ix_product_bids_product_id'), 'product_bids', ['product_id'], unique=False
    )
    ...
    op.add_column(
        'products', sa.Column('verified', sa.Boolean(), nullable=False, server_default='false')
    )
    ...
    op.add_column(
        'run_participations',
        sa.Column('is_helper', sa.Boolean(), nullable=False, server_default='false'),
    )
    op.add_column(
        'run_participations',
    ...
    op.create_index(
        op.f('ix_run_participations_run_id'), 'run_participations', ['run_id'], unique=False
    )
    op.create_index(
        op.f('ix_run_participations_user_id'), 'run_participations', ['user_id'], unique=False
    )
    op.create_index(
        'ix_run_participations_user_run', 'run_participations', ['user_id', 'run_id'], unique=False
    )
    ...
    op.add_column(
        'shopping_list_items', sa.Column('purchased_at', sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        'shopping_list_items',
        sa.Column(
    ...
    op.create_index(
        'ix_shopping_list_items_product', 'shopping_list_items', ['product_id'], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f('ix_shopping_list_items_run_id'), 'shopping_list_items', ['run_id'], unique=False
    )
    ...
    op.add_column(
        'stores', sa.Column('verified', sa.Boolean(), nullable=False, server_default='false')
    )
    op.add_column(
        'stores',
        sa.Column(
    ...
    op.add_column(
        'users', sa.Column('verified', sa.Boolean(), nullable=False, server_default='false')
    )
    op.add_column(
        'users',
        sa.Column(
...
def downgrade() -> None:
    ...
    op.add_column(
        'products',
        sa.Column(
            'base_price', sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=False
        ),
    )
    ...
    op.create_foreign_key(
        op.f('products_store_id_fkey'), 'products', 'stores', ['store_id'], ['id']
    )
    ...
    op.add_column(
        'product_bids', sa.Column('user_id', sa.UUID(), autoincrement=False, nullable=False)
    )
    op.add_column(
        'product_bids', sa.Column('run_id', sa.UUID(), autoincrement=False, nullable=False)
    )
    op.drop_constraint(None, 'product_bids', type_='foreignkey')
    op.create_foreign_key(
        op.f('product_bids_user_id_fkey'), 'product_bids', 'users', ['user_id'], ['id']
    )
    op.create_foreign_key(
        op.f('product_bids_run_id_fkey'), 'product_bids', 'runs', ['run_id'], ['id']
    )
    ...
    op.drop_index(
        'ix_reassignment_requests_to_user_status', table_name='leader_reassignment_requests'
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['encountered_by'], ['users.id'], name=op.f('encountered_prices_encountered_by_fkey')
        ),
        sa.ForeignKeyConstraint(
            ['product_id'], ['products.id'], name=op.f('encountered_prices_product_id_fkey')
        ),
        sa.ForeignKeyConstraint(
            ['store_id'], ['stores.id'], name=op.f('encountered_prices_store_id_fkey')
        ),
        sa.PrimaryKeyConstraint('id', name=op.f('encountered_prices_pkey')),
    )
    op.create_index(
        op.f('ix_encountered_prices_store_id'), 'encountered_prices', ['store_id'], unique=False
    )
    op.create_index(
        op.f('ix_encountered_prices_product_id'), 'encountered_prices', ['product_id'], unique=False
    )
    op.create_index(
        op.f('ix_encountered_prices_encountered_by'),
        'encountered_prices',
        ['encountered_by'],
        unique=False,
    )
    op.create_index(
        op.f('ix_encountered_prices_encountered_at'),
        'encountered_prices',
        ['encountered_at'],
        unique=False,
    )
